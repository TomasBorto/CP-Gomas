  ...
  return (
    ...
    <div className="flex items-center justify-center mb-12">
      ...
      <card className="relative h-[30rem] sm:h-96 w-[35rem] rounded-lg">
        ...
        {/* <!-- Background Image --> */}
        <img src={MercadoLibre} className="object-cover w-full h-full rounded-lg" />
        ...
        <div className="absolute w-full h-full bottom-0 bg-gradient-to-r from-fuchsia-700/30 to-violet-700 rounded-lg flex flex-col items-center justify-center text-center">
            ...
            <button className="group relative h-12 w-60 overflow-hidden rounded-lg bg-white text-lg shadow mt-10">
              ...
              <a className="relative text-black group-hover:text-white" href="">Compra en Mercado Libre</a>
            </button>
  ...
  return (
    ...
    <div className="flex items-center justify-center mb-12">
      ...
      <card className="relative h-[30rem] sm:h-96 w-[35rem] rounded-lg">
        ...
        {/* <!-- Background Image --> */}
        <img src={Local} className="object-cover w-full h-full rounded-lg" />
        ...
        <div className="absolute w-full h-full bottom-0 bg-gradient-to-r from-fuchsia-700/30 to-violet-700 rounded-lg flex flex-col items-center justify-center text-center">
            ...
            <button className="group relative h-12 w-60 overflow-hidden rounded-lg bg-white text-lg shadow mt-10">
              ...
              <a className="relative text-black group-hover:text-white" href="https://wa.link/q4gcol">Compra por WhatsApp</a>
            </button>
